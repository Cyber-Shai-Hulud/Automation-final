...
class PageObject(BasePage):
    ...
    def product_name_in_basket_the_same_as_on_page(self):
        ...
        assert added_to_basket_name_product in product_name_on_page, 'Wrong name displayed in basket'
    ...
    def product_price_same_as_in_basket(self):
        ...
        assert added_to_basket_product_price in book_price_product_page, 'Wrong price displayed in basket'
